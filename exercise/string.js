const string = "I could be anything you like, but not anything you want";

// console.log(string.length); // 28 - string is 28 characters long
console.log(string.indexOf("could")); // 11 - starting at 0 for 'I'
console.log(string.lastIndexOf("could"));
...
// // console.log(string.indexOf("z")); // 11 - starting at 0 for 'I'
